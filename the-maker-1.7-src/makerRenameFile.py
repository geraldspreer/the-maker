...
class Controller(makerController.SuperController):
    ...
    def bindActions(self):
        ...
        self.view.Ok.Bind(wx.EVT_BUTTON, 
                       self.onOk)
    ...
    def onOk(self, event):
        ...
        nName = os.path.join(self.model.fileModel.core.getPathParts(),
        ...
        if os.path.isfile(nName): 
            ...
            self.model.fileController.view.tree.SetItemText(self.model.fileController.getReferringTreeItem(), newName)
            ...
            if not self.model.fileModel.getSaved():
                newName += "*"
            self.model.fileController.noteBook.SetPageText(self.model.fileController.noteBook.GetSelection(), newName)
            self.view.Destroy()
