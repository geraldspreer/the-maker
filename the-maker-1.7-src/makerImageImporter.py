...
class Controller(makerController.SuperController):
    ...
    def Reset(self, event):
        #print self.view.keepRatio.GetValue()
...
class MakerImageImporter:
    ...
    def __init__(self, projectModel, mainView):
        ...
        # the file dialog is returning a list of files 
        # making sure we are only processing one of them
    ...
    def getPreview(self):
        ...
        # set original values in x/y field in view
