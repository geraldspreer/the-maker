...
def choice(dict):
    return wx.Choice(choices=dict['choices'],
                     id=wx.NewId(), 
                     name=dict['name'],
                     parent=dict['parent'], 
                     pos=dict['pos'],
...
def listBox(dict):
    theID = wx.NewId()
    listBox = wx.ListBox(choices=dict['choices'], 
                         id=theID,
                         name=dict['name'], 
                         parent=dict['parent'], 
                         pos=dict['pos'],
                         size=dict['size'],
                         style=dict['style'])
    listBox.Bind(wx.EVT_LISTBOX_DCLICK, 
                 dict['handler'],
                 id=theID)
    return listBox
...
def staticLine(dict):
    return wx.StaticLine(id=wx.NewId(),
                         name=dict['name'],
                         parent=dict['parent'], 
                         pos=dict['pos'],
                         size=dict['size'],
...
def staticText(dict):
    return wx.StaticText(id=wx.NewId(),
                         label=dict['label'],
                         name=dict['name'],
                         parent=dict['parent'], 
                         pos=dict['pos'],
...
def staticBitmap(dict):    
    return wx.StaticBitmap(bitmap=dict['bitmap'],
                           id=wx.NewId(), 
                           name=dict['name'], 
                           parent=dict['parent'],
                           pos=dict['pos'],
...
def textCtrl(dict):
    return wx.TextCtrl(id=wx.NewId(),
                       name=dict['name'],
                       parent=dict['parent'], 
                       pos=dict['pos'],
                       size=dict['size'],
...
def styledTextCtrl(dict):
    idValue = -1
    if dict['hasID']: idValue = wx.NewId()
    
    sCtrl = wx.stc.StyledTextCtrl(id=idValue,
                                  name=dict['name'], 
                                  parent=dict['parent'], 
                                  pos=dict['pos'],
                                  size=dict['size'],
