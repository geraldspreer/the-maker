...
class editorView:
    ...
    def applyCodeStyle(self, style=None):
        ...
        self.editor.SetCaretLineBack(
            style["meta.highlight.currentline"]["background-color"]
        )
        ...
        if self.editor.GetLexer() == wx.stc.STC_LEX_HTML:
            ...
            self.editor.StyleSetSpec(
                ...
                "fore:"
                + style["markup.tag.attribute.name"]["color"]
                + ",back:"
                + style["meta.default"]["background-color"]
                + ",face:%(other)s,size:%(size)d" % faces,
            )
            ...
            self.editor.StyleSetSpec(
                ...
                "fore:"
                + style["markup.comment"]["color"]
                + ",back:"
                + style["meta.default"]["background-color"]
                + ",italic,face:%(other)s,size:%(size)d" % faces,
            )
            ...
            self.editor.StyleSetSpec(
                wx.stc.STC_H_NUMBER,
                "fore:"
                + style["markup.tag.attribute.value"]["color"]
                + ",back:"
                + style["meta.default"]["background-color"]
                + ",face:%(other)s,size:%(size)d" % faces,
            )
            ...
            self.editor.StyleSetSpec(
                wx.stc.STC_H_ENTITY,
                "fore:"
                + style["markup.constant.entity"]["color"]
                + ",back:"
                + style["meta.default"]["background-color"]
                + ",face:%(other)s,size:%(size)d" % faces,
            )
            ...
            self.editor.StyleSetSpec(
                wx.stc.STC_H_CDATA,
                "fore:"
                + style["markup.inline.cdata"]["color"]
                + ",back:"
                + style["meta.default"]["background-color"]
                + ",face:%(other)s,size:%(size)d" % faces,
            )
            ...
            self.editor.StyleSetSpec(
                ...
                "fore:"
                + style["constant.numeric.keyword"]["color"]
                + ",back:"
                + style["meta.default"]["background-color"]
                + ",face:%(other)s,size:%(size)d" % faces,
            )
            ...
            self.editor.StyleSetSpec(
                ...
                "fore:"
                + style["style.value.numeric"]["color"]
                + ",back:"
                + style["meta.default"]["background-color"]
                + ",face:%(other)s,size:%(size)d" % faces,
            )
            ...
            self.editor.StyleSetSpec(
                ...
                "fore:"
                + style["style.value.keyword"]["color"]
                + ",back:"
                + style["meta.default"]["background-color"]
                + ",face:%(other)s,size:%(size)d" % faces,
            )
            ...
            self.editor.StyleSetSpec(
                ...
                "fore:"
                + style["style.value.string"]["color"]
                + ",back:"
                + style["meta.default"]["background-color"]
                + ",face:%(other)s,size:%(size)d" % faces,
            )
            ...
            self.editor.StyleSetSpec(
                ...
                "fore:"
                + style["style.property.name"]["color"]
                + ",back:"
                + style["meta.default"]["background-color"]
                + ",face:%(other)s,size:%(size)d" % faces,
            )
            ...
            self.editor.StyleSetSpec(
                wx.stc.STC_CSS_EXTENDED_IDENTIFIER,
                "fore:"
                + style["style.property.name"]["color"]
                + ",back:"
                + style["meta.default"]["background-color"]
            ...
            self.editor.StyleSetSpec(
                wx.stc.STC_CSS_EXTENDED_PSEUDOCLASS,
                "fore:"
                + style["style.property.name"]["color"]
                + ",back:"
                + style["meta.default"]["background-color"]
                + ",face:%(other)s,size:%(size3)d" % faces,
            )
            self.editor.StyleSetSpec(
                wx.stc.STC_CSS_EXTENDED_PSEUDOELEMENT,
                "fore:"
                + style["style.property.name"]["color"]
                + ",back:"
                + style["meta.default"]["background-color"]
