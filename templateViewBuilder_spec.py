...
class TemplateTest(unittest.TestCase):
    ...
    def test_templateView(self):
        ...
        self.assertTrue(
            os.path.isfile(os.path.join(self.viewPath, "yourTemplates.html")),
            "Template file has been created",
        )

        contents = readFile(os.path.join(self.viewPath, "yourTemplates.html"))

        self.assertTrue(
            contents.find(os.path.join(self.sysPath, "jquery.min.js")) != -1,
            "Correct jquery reference found in view...",
        )
    ...
    def test_paths(self):
        ...
        self.assertTrue(
            os.path.isfile(os.path.join(self.sysPath, "Splash.png")),
